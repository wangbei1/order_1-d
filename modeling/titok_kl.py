...
from modeling.distributions.distributions_orig import DiagonalGaussianDistribution
...
class TiTok_KL(nn.Module):
    ...
    def encode(self, x):
        z = self.encoder(pixel_values=x, latent_tokens=self.latent_tokens)   # N 12 1 32
